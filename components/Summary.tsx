...
interface SummaryProps {
  ...
  shedDescription: string | null;
}

export const Summary: React.FC<SummaryProps> = ({ config, totalPrice, onGenerate, isLoading, onGenerateDescription, isGeneratingDescription, shedDescription }) => {
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg sticky top-8">
      ...
      <div className="my-6">
        <button
          ...
          disabled={!isComplete || isGeneratingDescription}
